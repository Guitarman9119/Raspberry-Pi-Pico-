...
hour_pins = [Pin(pin, Pin.OUT) for pin in [0,1,2,3,4]]
minute_pins = [Pin(pin, Pin.OUT) for pin in [5,6,7,8,9,10]]
second_pins = [Pin(pin, Pin.OUT) for pin in [19,15,14,13,12,11]]
